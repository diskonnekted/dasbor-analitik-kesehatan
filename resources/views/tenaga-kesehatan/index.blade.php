...
<div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
        <h3 class="text-lg font-bold text-gray-900">Daftar Tenaga Kesehatan</h3>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-100">
                <tr>
                    <?php foreach(['ID', 'Kecamatan', 'Tahun', 'Dokter', 'Perawat', 'Bidan', 'Farmasi', 'Total'] as $col): ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <?php foreach([$item->id, $item->kecamatan_nama, $item->tahun, $item->dokter_umum, $item->perawat, $item->bidan, $item->farmasi, $item->total] as $val): ?>
